 ...
 */
public class UserJobSearch extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mWebView.loadUrl("http://www.indeed.com/m/");
        mWebView.setWebViewClient(new com.example.admin.qbreaker.WebViewClient.MyAppWebViewClientJob(){
            @Override
