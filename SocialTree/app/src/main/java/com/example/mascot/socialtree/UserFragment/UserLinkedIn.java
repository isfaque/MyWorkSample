 ...
 */
public class UserLinkedIn extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_linkedin, container, false);
        ...
        mWebView.setWebViewClient(new com.example.mascot.socialtree.WebViewClient.WebViewClientLinkedIn(){
            @Override
