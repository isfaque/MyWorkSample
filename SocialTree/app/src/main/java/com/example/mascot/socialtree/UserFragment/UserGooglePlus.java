 ...
 */
public class UserGooglePlus extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        MainActivity.isUserGooglePlusShown=true;
        ...
        mCallback.onArticleSelected("Hello World GooglePlus");
        ...
        mWebView.setWebViewClient(new com.example.mascot.socialtree.WebViewClient.WebViewClientGooglePlus(){
            @Override
