 ...
 */
public class UserLastfm extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_lastfm, container, false);
        ...
        MainActivity.isUserLastfmShown=true;
        ...
        mCallback.onArticleSelected("Hello World Lastfm");
        ...
        mWebView.loadUrl("https://www.last.fm/");
        mWebView.setWebViewClient(new com.example.mascot.socialtree.WebViewClient.WebViewClientLastfm(){
            @Override
