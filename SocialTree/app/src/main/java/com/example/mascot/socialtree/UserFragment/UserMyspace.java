 ...
 */
public class UserMyspace extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_myspace, container, false);
        ...
        MainActivity.isUserMyspaceShown=true;
        MainActivity.isUserRedditShown=false;
        MainActivity.isUserTwitterShown=false;

        mCallback.onArticleSelected("Hello World Myspace");
        ...
        mWebView.loadUrl("https://myspace.com/");
        mWebView.setWebViewClient(new com.example.mascot.socialtree.WebViewClient.WebViewClientMyspace(){
            @Override
