 ...
 */
public class UserFacebook extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        MainActivity.isUserFacebookShown=true;
        ...
        mCallback.onArticleSelected("Hello World Facebook");
        ...
        mWebView.setWebViewClient(new com.example.mascot.socialtree.WebViewClient.WebViewClientFacebook(){
            @Override
