 ...
 */
public class DriverHomeTaskSeven extends Fragment {

    private GoogleMap mMap;

    String Url ="http://hicabs-system.com/Api/getdriversingletask";
    String UrlComplete ="http://hicabs-system.com/Api/drivertaskseven";

    AlertDialog alertDialog;

    JSONObject jArray;
    Button btn_driver_task7_payment;
    TextView txt_driver_task7_pickup_details, txt_driver_task7_stop_no, txt_driver_task7_booking_no, txt_driver_task7_pickup_town, txt_driver_task7_pickup_street, txt_driver_task7_drop_town, txt_driver_task7_drop_street, txt_driver_task7_amount, txt_driver_task7_status;
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        View v = inflater.inflate(R.layout.fragment_home_task_seven_driver, container, false);
        ...
        txt_driver_task7_booking_no = (TextView) v.findViewById(R.id.txt_driver_task7_booking_no);
        txt_driver_task7_pickup_town = (TextView) v.findViewById(R.id.txt_driver_task7_pickup_town);
        txt_driver_task7_pickup_street = (TextView) v.findViewById(R.id.txt_driver_task7_pickup_street);
        txt_driver_task7_pickup_details = (TextView) v.findViewById(R.id.txt_driver_task7_pickup_details);
        txt_driver_task7_drop_town = (TextView) v.findViewById(R.id.txt_driver_task7_drop_town);
        txt_driver_task7_drop_street = (TextView) v.findViewById(R.id.txt_driver_task7_drop_street);
        txt_driver_task7_amount = (TextView) v.findViewById(R.id.txt_driver_task7_amount);
        txt_driver_task7_status = (TextView) v.findViewById(R.id.txt_driver_task7_status);
        txt_driver_task7_stop_no = (TextView) v.findViewById(R.id.txt_driver_task7_stop_no);

        btn_driver_task7_payment = (Button) v.findViewById(R.id.btn_driver_task7_payment);


        btn_driver_task7_payment.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        SupportMapFragment mapFragment = (SupportMapFragment) getChildFragmentManager()
                .findFragmentById(R.id.driver_task7_map);
                ...
                try {
                    if (booking_data.equals("yes")) {
                        ...
                        try {
                            ...
                            txt_driver_task7_booking_no.setText(driver_dbooking_id);
                            txt_driver_task7_pickup_town.setText(driver_picktown_code.toUpperCase());
                            txt_driver_task7_pickup_street.setText(driver_picktown_address);
                            txt_driver_task7_pickup_details.setText(driver_booking_nameonboard+", "+driver_booking_flightdetails+", "+driver_booking_comment);
                            txt_driver_task7_drop_town.setText(driver_droptown_code.toUpperCase());
                            txt_driver_task7_drop_street.setText(driver_droptown_address);
                            if(driver_booking_amount.toString().equals("A/C")){
                                txt_driver_task7_amount.setText(driver_booking_amount);
                            }else{
                                txt_driver_task7_amount.setText("€"+driver_booking_amount);
                            }
                            txt_driver_task7_status.setText("Task Completed");
                            txt_driver_task7_stop_no.setText(driver_stop);
