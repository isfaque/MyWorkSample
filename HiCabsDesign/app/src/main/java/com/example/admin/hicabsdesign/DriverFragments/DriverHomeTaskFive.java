 ...
 */
public class DriverHomeTaskFive extends Fragment {

    private GoogleMap mMap;

    String Url ="http://hicabs-system.com/Api/getdriversingletask";
    String UrlStop ="http://hicabs-system.com/Api/drivertaskfive";
    String UrlComplete ="http://hicabs-system.com/Api/drivertasksix";
    AlertDialog alertDialog;

    JSONObject jArray;

    Button btn_driver_task5_stop3, btn_driver_task5_completed;
    TextView txt_driver_task5_booking_no, txt_driver_task5_pickup_town, txt_driver_task5_pickup_street, txt_driver_task5_drop_town, txt_driver_task5_drop_street, txt_driver_task5_amount, txt_driver_task5_status;
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        View v = inflater.inflate(R.layout.fragment_home_task_five_driver, container, false);
        ...
        txt_driver_task5_booking_no = (TextView) v.findViewById(R.id.txt_driver_task5_booking_no);
        txt_driver_task5_pickup_town = (TextView) v.findViewById(R.id.txt_driver_task5_pickup_town);
        txt_driver_task5_pickup_street = (TextView) v.findViewById(R.id.txt_driver_task5_pickup_street);
        txt_driver_task5_drop_town = (TextView) v.findViewById(R.id.txt_driver_task5_drop_town);
        txt_driver_task5_drop_street = (TextView) v.findViewById(R.id.txt_driver_task5_drop_street);
        txt_driver_task5_amount = (TextView) v.findViewById(R.id.txt_driver_task5_amount);
        txt_driver_task5_status = (TextView) v.findViewById(R.id.txt_driver_task5_status);

        btn_driver_task5_stop3 = (Button) v.findViewById(R.id.btn_driver_task5_stop3);
        btn_driver_task5_completed = (Button) v.findViewById(R.id.btn_driver_task5_completed);

        btn_driver_task5_stop3.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        btn_driver_task5_completed.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                status = "yes";
                setComplete();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        SupportMapFragment mapFragment = (SupportMapFragment) getChildFragmentManager()
                .findFragmentById(R.id.driver_task5_map);
                ...
                try {
                    if (booking_data.equals("yes")) {
                        ...
                        try {
                            ...
                            txt_driver_task5_booking_no.setText(driver_confirm_booking_id);
                            txt_driver_task5_pickup_town.setText(driver_picktown_code);
                            txt_driver_task5_pickup_street.setText(driver_picktown_address);
                            txt_driver_task5_drop_town.setText(driver_droptown_code);
                            txt_driver_task5_drop_street.setText(driver_droptown_address);
                            if(driver_booking_amount.toString().equals("A/C")){
                                txt_driver_task5_amount.setText(driver_booking_amount);
                            }else{
                                txt_driver_task5_amount.setText("€"+driver_booking_amount);
                            }

                            txt_driver_task5_status.setText("Stop2 Activated");
