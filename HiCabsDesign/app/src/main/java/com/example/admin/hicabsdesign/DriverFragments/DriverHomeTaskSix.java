 ...
 */
public class DriverHomeTaskSix extends Fragment {
    ...
    Button btn_driver_task6_completed;
    TextView txt_driver_task6_booking_no, txt_driver_task6_pickup_town, txt_driver_task6_pickup_street, txt_driver_task6_drop_town, txt_driver_task6_drop_street, txt_driver_task6_amount, txt_driver_task6_status;
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        View v = inflater.inflate(R.layout.fragment_home_task_six_driver, container, false);
        ...
        txt_driver_task6_booking_no = (TextView) v.findViewById(R.id.txt_driver_task6_booking_no);
        txt_driver_task6_pickup_town = (TextView) v.findViewById(R.id.txt_driver_task6_pickup_town);
        txt_driver_task6_pickup_street = (TextView) v.findViewById(R.id.txt_driver_task6_pickup_street);
        txt_driver_task6_drop_town = (TextView) v.findViewById(R.id.txt_driver_task6_drop_town);
        txt_driver_task6_drop_street = (TextView) v.findViewById(R.id.txt_driver_task6_drop_street);
        txt_driver_task6_amount = (TextView) v.findViewById(R.id.txt_driver_task6_amount);
        txt_driver_task6_status = (TextView) v.findViewById(R.id.txt_driver_task6_status);

        btn_driver_task6_completed = (Button) v.findViewById(R.id.btn_driver_task6_completed);


        btn_driver_task6_completed.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        SupportMapFragment mapFragment = (SupportMapFragment) getChildFragmentManager()
                .findFragmentById(R.id.driver_task6_map);
                ...
                try {
                    if (booking_data.equals("yes")) {
                        ...
                        try {
                            ...
                            txt_driver_task6_booking_no.setText(driver_confirm_booking_id);
                            txt_driver_task6_pickup_town.setText(driver_picktown_code);
                            txt_driver_task6_pickup_street.setText(driver_picktown_address);
                            txt_driver_task6_drop_town.setText(driver_droptown_code);
                            txt_driver_task6_drop_street.setText(driver_droptown_address);
                            if(driver_booking_amount.toString().equals("A/C")){
                                txt_driver_task6_amount.setText(driver_booking_amount);
                            }else{
                                txt_driver_task6_amount.setText("€"+driver_booking_amount);
                            }

                            txt_driver_task6_status.setText("Stop3 Activated");
