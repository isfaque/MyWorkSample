 ...
 */
public class DriverHomeTaskThree extends Fragment {

    private GoogleMap mMap;

    String Url ="http://hicabs-system.com/Api/getdriversingletask";
    String UrlStop ="http://hicabs-system.com/Api/drivertaskthree";
    ...
    ProgressDialog progressDialog, progressDialogStop;

    Button btn_driver_task3_stop1, btn_driver_task3_completed;
    TextView txt_driver_task3_pickup_details, txt_driver_task3_stop_no, txt_driver_task3_booking_no, txt_driver_task3_pickup_town, txt_driver_task3_pickup_street, txt_driver_task3_drop_town, txt_driver_task3_drop_street, txt_driver_task3_amount, txt_driver_task3_status;
    ...
    public static String driver_accepted, driver_picked, driver_stop, driver_stop2, driver_stop3, driver_completed;
    public static String driver_booking_nameonboard, driver_booking_flightdetails, driver_booking_comment;

    @Override
    public View onCreateView(LayoutInflater inflater,
                             @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_home_task_three_driver, container, false);
        ...
        //Get webview
        webView = (WebView) v.findViewById(R.id.webViewdriver3);
        webView.getSettings().setJavaScriptEnabled(true);
        webView.getSettings().setJavaScriptCanOpenWindowsAutomatically(true);

        setConfirmdata();

        txt_driver_task3_booking_no = (TextView) v.findViewById(R.id.txt_driver_task3_booking_no);
        txt_driver_task3_pickup_town = (TextView) v.findViewById(R.id.txt_driver_task3_pickup_town);
        txt_driver_task3_pickup_street = (TextView) v.findViewById(R.id.txt_driver_task3_pickup_street);
        txt_driver_task3_pickup_details = (TextView) v.findViewById(R.id.txt_driver_task3_pickup_details);
        txt_driver_task3_drop_town = (TextView) v.findViewById(R.id.txt_driver_task3_drop_town);
        txt_driver_task3_drop_street = (TextView) v.findViewById(R.id.txt_driver_task3_drop_street);
        txt_driver_task3_amount = (TextView) v.findViewById(R.id.txt_driver_task3_amount);
        txt_driver_task3_status = (TextView) v.findViewById(R.id.txt_driver_task3_status);
        txt_driver_task3_stop_no = (TextView) v.findViewById(R.id.txt_driver_task3_stop_no);

        btn_driver_task3_stop1 = (Button) v.findViewById(R.id.btn_driver_task3_stop1);
        btn_driver_task3_completed = (Button) v.findViewById(R.id.btn_driver_task3_completed);

        btn_driver_task3_stop1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                /*
                if (progressDialogStop == null) {
                    // in standard case YourActivity.this
                    progressDialogStop = new ProgressDialog(getActivity());
                    progressDialogStop.setMessage("Loading...");
                    progressDialogStop.show();
                }*/

                btn_driver_task3_stop1.setEnabled(false);
        ...
        btn_driver_task3_completed.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                btn_driver_task3_completed.setEnabled(false);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        SupportMapFragment mapFragment = (SupportMapFragment) getChildFragmentManager()
                .findFragmentById(R.id.driver_task3_map);
        ...
        client.get(Url, params, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(String response) {
                ...
                try {
                    ...
                    driver_stop = jArray.getString("driverstop");
                    Log.i("Booking stop1 is", driver_stop);
                ...
                try {
                    if (booking_data.equals("yes")) {
                        ...
                        try {
                            ...
                            txt_driver_task3_booking_no.setText(driver_dbooking_id);
                            txt_driver_task3_pickup_town.setText(driver_picktown_code.toUpperCase());
                            txt_driver_task3_pickup_street.setText(driver_picktown_address);
                            txt_driver_task3_pickup_details.setText(driver_booking_nameonboard+", "+driver_booking_flightdetails+", "+driver_booking_comment);
                            txt_driver_task3_drop_town.setText(driver_droptown_code.toUpperCase());
                            txt_driver_task3_drop_street.setText(driver_droptown_address);
                            if(driver_booking_amount.toString().equals("A/C")){
                                txt_driver_task3_amount.setText(driver_booking_amount);
                            }else{
                                txt_driver_task3_amount.setText("€"+driver_booking_amount);
                            }

                            txt_driver_task3_status.setText("Client Picked");
                            txt_driver_task3_stop_no.setText(driver_stop);
            ...
            public void onSuccess(String response) {
                ...
                try {
                    if (update_message.equals("updated")) {
                        btn_driver_task3_stop1.setEnabled(true);
                    ...
                    // TODO: handle exception
                    Toast tost = new Toast(getActivity());
                    tost.makeText(getActivity(), "Please check internet connection", Toast.LENGTH_LONG).show();
                    tost.setGravity(Gravity.TOP | Gravity.LEFT, 0, 0);
                    //Intent i = new Intent(getActivity(), SplashActivity.class);
                    //startActivity(i);
                    e.printStackTrace();
            ...
            public void onSuccess(String response) {
                ...
                try {
                    if (update_message.equals("updated")) {
                        ...
                        btn_driver_task3_completed.setEnabled(true);
                        Toast.makeText(getActivity(), "Action not updated", Toast.LENGTH_LONG).show();
                    }
